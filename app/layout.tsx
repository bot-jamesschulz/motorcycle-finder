      ...
      <body className={`${inter.className} flex flex-col justify-between min-h-screen`}>
        ...
        >
          <Suspense>
            ...
            <footer className='flex flex-col justify-center items-center w-full mt-72  py-4 bg-slate-200 shadow dark:bg-slate-950 dark:text-slate-50 text-center rounded-t-2xl'>
              <Footer />
            </footer>
          </Suspense>
        </ThemeProvider>
